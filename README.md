...
For access and administration, the image comes preinstalled with SSH access and
[cockpit](https://cockpit-project.org/) web interface at [https://mbl-debian](https://mbl-debian).
